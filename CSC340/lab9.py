...
#TODO: Given the coloringSolution and graphMatrix as a 2D numpy array,
#check if the coloring solution is valid.
#Return true if it is a valid coloring solution, false otherwise.
    numVertex = graphMatrix.shape[0]
    #loop thru and check if 2 connected nodes are the name color
...
graphMatrix[3,1] = 1
graphMatrix[3,2] = 1
print('min colors:', FindMinColor(graphMatrix))